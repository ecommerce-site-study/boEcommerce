...
import com.teckstudy.book.config.permit.PermitAllFilter;
import com.teckstudy.book.config.security.AjaxLoginConfigurer;
import com.teckstudy.book.config.security.UserDetailsServiceImpl;
import com.teckstudy.book.config.security.common.FormWebAuthenticationDetailsSource;
import com.teckstudy.book.config.security.factory.UrlResourcesMapFactoryBean;
...
import com.teckstudy.book.config.security.handler.FormAccessDeniedHandler;
...
import com.teckstudy.book.config.security.provider.FormAuthenticationProvider;
...
//                .antMatchers(HttpMethod.POST, "/authorize").anonymous()
