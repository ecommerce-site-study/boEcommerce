...
//
//        // 글자 벨리데이션
//        nameValidation(searchExhibitionDto.getName());
//
//        // 컨텐츠 벨리데이션(컨텐츠정보, 컨텐츠 최대갯수, 컨텐츠 묶음갯수)
//        boContentValidation(contentInfo, searchExhibitionDto.getContentsList(), searchExhibitionDto.getBundleContentCnt());
//
//        // 전시기간 벨리데이션
//        dateValidation(searchExhibitionDto.getDateYn(), searchExhibitionDto.getExhibitionStart(), searchExhibitionDto.getExhibition_end());
//
//        // 이미지 벨리데이션
//        imageValidation(searchExhibitionDto.getExhibitionType(), searchExhibitionDto.getImage());
//
//        // 파일 사이즈 체크
