package com.teckstudy.book.feature.ui.authentication;

import com.teckstudy.book.feature.application.member.MemberService;
import com.teckstudy.book.feature.config.jwt.JwtProvider;
import com.teckstudy.book.feature.config.security.StatelessCSRFFilter;
import com.teckstudy.book.feature.config.security.UserDetailsImpl;
import com.teckstudy.book.feature.domain.oauth2.*;
import com.teckstudy.book.feature.domain.oauth2.account.OAuth2AccountDTO;
import com.teckstudy.book.feature.domain.oauth2.service.OAuth2Service;
import com.teckstudy.book.feature.domain.oauth2.service.OAuth2ServiceFactory;
import com.teckstudy.book.feature.domain.oauth2.userInfo.OAuth2UserInfo;
import com.teckstudy.book.feature.lib.common.fuction.exception.AuthenticationFailedException;
import com.teckstudy.book.feature.lib.common.fuction.exception.ValidationException;
import com.teckstudy.book.feature.lib.common.util.CookieUtils;
import com.teckstudy.book.feature.ui.authentication.request.AuthorizationRequest;
