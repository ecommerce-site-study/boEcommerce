...
//        }
//
//        OrderItem ordersItem = OrderItem.builder()
//                    .member(members)
...
//                    .build();
//
//        bookOrderRepository.save(ordersItem);
//
...
//                .orderItem(ordersItem)
//                .total_price(ordersItem.getOrder_price())
//                .build();
//
...
//            assertThat(pay.getOrderItem().getOrder_sn()).isEqualTo(1L);
